...
.. figure:: _static/trento_events_p.png
   :align: center
   :alt: Pb-Pb events
...
``trento`` prints the following event properties to stdout: event number, impact parameter, number of participants, total yield (energy or entropy), and eccentricity harmonics 2--5.
